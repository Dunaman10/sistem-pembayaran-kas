...
<body style="font-family: 'Oswald', sans-serif;" class="bg-gradient-to-r from-slate-200 to-slate-100">
	...
	<section class="fixed right-10 bottom-28 w-16 h-16 shadow-lg rounded-full">
		...
		<div id="detail-profil"
			class="hidden fixed w-64 h-20 bg-white shadow-xl shadow-sky-200 right-10 bottom-[13rem] rounded-3xl rounded-br-none">
	...
	<section class="pt-36 min-h-screen sm:pt-24 lg:pt-40 hover:text-sky-200" id="about">
		<div class="container lg:mx-auto lg:flex md:block sm:block items-center justify-center lg:px-12">
			<div class="text-center px-6" data-aos="fade-up" data-aos-duration="1500">
				...
				<p class="text-slate-800 font-light text-lg">Di tengah gemerlapnya kampus, kita menjalani perjalanan pendidikan penuh tantangan. Setiap hari, kita penuhi kelas dengan semangat belajar, mengasah keterampilan, dan membentuk persahabatan yang tak terlupakan. Di sini, kita tidak hanya mengejar impian, tetapi juga membentuk masa depan cerah dengan tekad bersama.</p>
			</div>
	...
	<!-- My Javascript -->
	<script src="dist/script_mahasiswa.js"></script>
